...
func (in *AttractorSpec) DeepCopyInto(out *AttractorSpec) {
	*out = *in
	...
	if in.NSEReplicas != nil {
		in, out := &in.NSEReplicas, &out.NSEReplicas
		*out = new(int32)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBStatusType) DeepCopyInto(out *LBStatusType) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBStatusType.
func (in *LBStatusType) DeepCopy() *LBStatusType {
	if in == nil {
		return nil
	}
	out := new(LBStatusType)
	in.DeepCopyInto(out)
	return out
}
