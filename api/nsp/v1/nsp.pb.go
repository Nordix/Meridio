...
var file_api_nsp_v1_nsp_proto_rawDesc = []byte{
	...
	,
	...
	0x15, 0x2e, 0x6e, 0x73, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x27,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x6e,
	0x73, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x2e, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x1a, 0x3a, 0x0a, 0x0c, 0x43, 0x6f, 0x6e, 0x74, 0x65,
...
var file_api_nsp_v1_nsp_proto_depIdxs = []int32{
	...
	7,  // 1: nsp.v1.Target.context:type_name -> nsp.v1.Target.ContextEntry
	0,  // 2: nsp.v1.Target.status:type_name -> nsp.v1.Target.Status
	1,  // 3: nsp.v1.Target.type:type_name -> nsp.v1.Target.Type
	1,  // 4: nsp.v1.TargetType.type:type_name -> nsp.v1.Target.Type
	4,  // 5: nsp.v1.TargetEvent.target:type_name -> nsp.v1.Target
	2,  // 6: nsp.v1.TargetEvent.status:type_name -> nsp.v1.TargetEvent.Status
	4,  // 7: nsp.v1.NetworkServicePlateformService.Register:input_type -> nsp.v1.Target
	4,  // 8: nsp.v1.NetworkServicePlateformService.Unregister:input_type -> nsp.v1.Target
	5,  // 9: nsp.v1.NetworkServicePlateformService.Monitor:input_type -> nsp.v1.TargetType
	5,  // 10: nsp.v1.NetworkServicePlateformService.GetTargets:input_type -> nsp.v1.TargetType
	4,  // 11: nsp.v1.NetworkServicePlateformService.Update:input_type -> nsp.v1.Target
	8,  // 12: nsp.v1.NetworkServicePlateformService.Register:output_type -> google.protobuf.Empty
	8,  // 13: nsp.v1.NetworkServicePlateformService.Unregister:output_type -> google.protobuf.Empty
	6,  // 14: nsp.v1.NetworkServicePlateformService.Monitor:output_type -> nsp.v1.TargetEvent
	3,  // 15: nsp.v1.NetworkServicePlateformService.GetTargets:output_type -> nsp.v1.GetTargetsResponse
	8,  // 16: nsp.v1.NetworkServicePlateformService.Update:output_type -> google.protobuf.Empty
