...
type TargetRegistryClient interface {
	...
	Update(ctx context.Context, in *Target, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *targetRegistryClient) Update(ctx context.Context, in *Target, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type TargetRegistryServer interface {
	...
	Update(context.Context, *Target) (*emptypb.Empty, error)
...
func (*UnimplementedTargetRegistryServer) Update(context.Context, *Target) (*emptypb.Empty, error) {
